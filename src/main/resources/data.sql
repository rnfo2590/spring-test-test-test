...
VALUES(1, 1, 'Javaの基本', 2500,pg_read_binary_file('C:/dragon.png'), '中古', 'Javaの学習用', 1,'謙汰','謙汰',0,0);
INSERT INTO items(category_id, customer_id, name, price, image, condition, detail, stock, creator,updater,ver_num,delete_flg) 
VALUES(1, 2,  '呪術海鮮', 650,pg_read_binary_file('C:/jyujyu.png'), '新品', '呪術海鮮最新刊', 1,'香穂','香穂',0,0);
